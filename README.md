...
With these fundamental capabilities, the attacker can run arbitrary code, download arbitrary payloads, and install arbitrary software on the host machine despite Claude Code running in full sandbox mode.
